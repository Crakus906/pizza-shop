...
import { clearCart, removeCartItems, plusCartItem, minusCartItem} from '../redux/actions/cart'
...
function Cart() {
  ...
  const onClearCart = () => {
    if(window.confirm('You sure')){dispatch(clearCart())}
  }
  ...
  const onClickOrder = () => {
    window.confirm('ВАШ ЗАКАЗ', items);
  };
